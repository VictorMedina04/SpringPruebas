...
public class AlumnoController {
	 ...
	 * Con @Autowired - Haciendo el atributo private y con el constructor - Con
	 * Setters (no la usaremos) Aquí vemos la segunda para que tengais al menos un
	 * ejemplo con esta ya que los anteriores han sido con @Autowired
	 */
	 ...
	 * estos irán teniendo rutas complicadas en los Mapping por eso, iremos
	 * agregando rutas más complejas, por ejemplo, en este caso, como en ambos casos
	 * es para agregar un nuevo alumno ponemos en la ruta /nuevo Veremos formas de
	 * ahorrar esta escritura de rutas cuando se hagan muy largas
	 * 
	...
	public String procesaFormulario(@ModelAttribute("alumno") Alumno alumno) {
		...
		// meter la ruta del html al que quiero ir
		return "redirect:/";
	}
