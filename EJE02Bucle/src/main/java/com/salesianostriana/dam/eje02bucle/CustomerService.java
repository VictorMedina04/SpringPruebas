...
public class CustomerService {
	...
	/*
	 * De nuevo, un método que nos provee una lista de clientes simulando que vienen
	 * de la base de datosd
	 */
	public List<Customer> getLista() {
		return Arrays.asList(new Customer(1, "Ángel", "Naranjo", "González", "male"),
